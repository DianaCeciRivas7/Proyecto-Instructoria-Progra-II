...
public class frmNuevoGenero extends javax.swing.JFrame {
    
    int codGen;
    String nomUsuario;
    Generos gen = new Generos();
    
    public frmNuevoGenero() {
        initComponents();
    ...
    public frmNuevoGenero(String nomUsuario) {
        initComponents();
    ...
    public void llenarCodigo() {
        ...
        try {
            while (rs.next()) {
                codGen = rs.getInt("maximo") + 1;
                lblCodigo.setText("" + codGen);
            }
        } catch (Exception e) {
        }
    }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        Object[] p = {lblCodigo.getText(), txtNombre.getText()};
        try {
            gen.AgregarGeneros(p);
        } catch (Exception e) {
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmNuevoGenero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmNuevoGenero().setVisible(true);
            }
        });
    }
